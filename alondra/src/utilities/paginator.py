...
from django.core.paginator import \
    Paginator, QuerySetPaginator, Page, InvalidPage, EmptyPage, PageNotAnInteger
...
def paginator (page, model, perpage=15):
   
    paginator = DiggPaginator(model, perpage, body=6, padding=2)
    try:
