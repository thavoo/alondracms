# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2018-05-25 08:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', models.TextField(verbose_name='SLUG_LABEL')),
                ('image', models.TextField(verbose_name='IMAGE_LABEL')),
                ('lft', models.PositiveIntegerField(db_index=True, editable=False)),
                ('rght', models.PositiveIntegerField(db_index=True, editable=False)),
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='navigation_item_parent', to='navigation.NavigationItem', verbose_name='PARENT_LABEL')),
            ],
            options={
